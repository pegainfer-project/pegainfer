...
| `models/qwen35/tp-implementation.md` | Qwen3.5 TP Phase 1 is complete; P2A steps 1-3 add lifecycle baselines, pre-admission cancellation, start-gated broadcasts, exact-rank replies, and lifecycle-aware drop proof; scheduler fail-closed propagation is next. |
