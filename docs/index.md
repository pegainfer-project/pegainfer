...
| `models/qwen35/tp-implementation.md` | Qwen3.5 TP Phase 1 is complete; P2A steps 1-2 add exact-rank lifecycle baselines and production cancellation pruning before load/admission, with protocol hardening and unified execution next. |
