...
| `models/qwen35/tp-implementation.md` | Qwen3.5 TP Phase 1 is complete; P2A step 1 adds test-only exact-rank worker snapshots plus verified full-capacity cleanup and numeric readmission gates, while production lifecycle/unified execution and P2B GDR sharding remain follow-up. |
