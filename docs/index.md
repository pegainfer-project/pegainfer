...
| `models/qwen35/flashinfer-gdn-prefill.md` | Explicit SM120/TP1 FlashInfer GDN candidate: stable AOT boundary, lower prefill scratch and workload-dependent serving tradeoffs; Triton remains the default. |
