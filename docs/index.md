...
| `models/qwen35/tp-implementation.md` | Qwen3.5 TP Phase 1 is complete; P2A steps 1-4 add lifecycle baselines, pre-admission cancellation, start-gated exact-rank worker protocol, lifecycle-aware drop proof, and fail-closed scheduler completion/error propagation; unified execution is next. |
