...
// PegaInfer trim (see PROVENANCE.md): upstream instantiates 14 variants here;
// this build keeps only what pegainfer-k3 launches — fp32 carried state,
// non-varlen (B=1 chunk with state in and out). Everything above this line is
// upstream verbatim.
